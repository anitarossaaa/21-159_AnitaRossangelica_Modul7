...
<body>
    ...
    <div class="container">
        ...
        <!-- Footer -->
        <footer class="text-center text-lg-start " style="background-color: #87CEFA; font-family:sans-serif;color:#191970;">
                ...
                <div class="container text-left text-md-start mt-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-10 col-lg-5 col-xl-5 mx-auto mb-4">
                            <!-- Content -->
                            <img src=<?php echo e(asset('storage/img/utm.png')); ?> alt="utm" style="width:30%; margin-top:20px; margin-left:35px;">
...
</html><?php /**PATH C:\xampp\htdocs\modul7\resources\views/mahasiswi.blade.php ENDPATH**/ ?>